...
or in ~/.fonts"
  ...
  (let ((maxwidth (xrandr-max-width)))
    ...
    (case maxwidth
      (1280 (set-frame-font "Inconsolata-12" t))
      (1440 (set-frame-font "Inconsolata-13" t))
      (1680 (set-frame-font "Inconsolata-14" t))
      (1920 (set-frame-font "Inconsolata-15.5" t))
      (3200 (set-frame-font "Inconsolata-16" t))
      (3840 (set-frame-font "Inconsolata-17" t))
      (0 (set-frame-font "Inconsolata-12" t)))))

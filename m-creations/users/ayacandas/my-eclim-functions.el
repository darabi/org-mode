...
(defun my-insert-serial-version-uuid()
  (interactive)
  (insert "private static final long serialVersionUID = 1L;"))

(defun my-eclim-maven-run-quick-package()
  (interactive)
...
(defun my-java-mode-hook ()
  ...
  (define-key c-mode-base-map (kbd "C-M-j") 'my-insert-serial-version-uuid)
  ...
  (define-key c-mode-base-map (kbd "C-<f9>") 'my-eclim-maven-run-quick-package)
...
;; Highlighting gud
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(defun my-java-debug-highlighting()
  (interactive)
...
(add-hook 'gud-mode-hook 'my-java-debug-highlighting)
...
(setq eclim-auto-save t
      ...
      eclimd-default-workspace "~/eclipse-wrk/isis"

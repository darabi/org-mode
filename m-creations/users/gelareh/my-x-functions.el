...
or in ~/.fonts"
  ...
  (let ((maxwidth (xrandr-max-width)))
    ...
    (case maxwidth
      (1280 (set-frame-font "DejaVu Sans Mono-10" t))
      (1440 (set-frame-font "DejaVu Sans Mono-11" t))
      (1680 (set-frame-font "DejaVu Sans Mono-12" t))
      (1920 (set-frame-font "DejaVu Sans Mono-13" t))
      (3200 (set-frame-font "DejaVu Sans Mono-14" t))
      (3840 (set-frame-font "DejaVu Sans Mono-16" t))
      (0 (set-frame-font "DejaVu Sans Mono-14" t)))))

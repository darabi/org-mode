...
; SMW BUG gefunden: Kollidiert mit isearch unter xemacs
...
;    (if (memq isearch-mode-map (current-keymaps))
;	(let ((map (make-keymap)))
...
; smw hier ist der isearch-fehler in Vorbereitung BUG

(when (eq org-enable-table-editor 'optimized)
  ;; If the user wants maximum table support, we need to hijack
  ;; some standard editing functions
  (org-remap org-mode-map
; wegen der XEmacs isearch Umlaute-Kollission auskommentiert
